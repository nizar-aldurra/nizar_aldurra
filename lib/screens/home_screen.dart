          ...
          child: ListView(
            ...
            children: [
              const DrawerHeader(
                ...
                child: Text('Social Media App',style: TextStyle(fontSize: 30),),
              ),
              ListTile(
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
          Text(posts[index].title, style: const TextStyle(fontSize: 30),),
        Text(
            posts[index].publishedAt?.timeZoneName == null ? 'null' : DateFormat('dd/mm/yyyy  hh:mm').format(posts[index]
                .publishedAt!),style: const TextStyle(fontSize:
            18),),
